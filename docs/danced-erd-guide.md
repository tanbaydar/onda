...
**Inputs:** `PRODUCT_QA_SPEC.md`, `danced-data-architecture.md`, the assumptions register (A1 revised: no cancellation cascade; A2: 24-month backfill), the recon fixtures.
