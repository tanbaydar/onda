...
**Answer:** The product supports retroactive logging for any past event present in Danced's canonical catalog. For v1, the target catalog window is the trailing 24 months in the seeded launch cities, loaded through a one-time pre-launch Resident Advisor backfill, plus all events acquired going forward.
