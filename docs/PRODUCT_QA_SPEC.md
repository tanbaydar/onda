...
- **Repository formalization** (`2c73b00`). `.gitignore` is hardened, the README presents the project clearly to external reviewers, and the full-history secrets audit was clean with zero rotations required. Design handoffs remain tracked under `frontend/design-handoffs/`.
