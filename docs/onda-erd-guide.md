...
**Inputs:** `PRODUCT_QA_SPEC.md`, `onda-data-architecture.md`, the assumptions register (A1 revised: no cancellation cascade; A2: approximately two months around launch), the recon fixtures.
