...
*Evidence: backend/ingestion/management/commands/sync_ra.py:Command · backend/ingestion/runner.py:run_sync · backend/catalog/views.py:_event_queryset · frontend/src/api.js:fetchJson · backend/ingestion/tests/test_runner.py::RunnerContractTests::test_happy_path_two_pages*
...
*Evidence: backend/ingestion/models.py:RawIngest · backend/ingestion/transformer.py:transform · backend/catalog/models.py:Event · backend/catalog/models.py:Venue · backend/catalog/models.py:Artist · backend/catalog/models.py:City · onda-data-architecture.md § The shape of the system*

<a id="nightly-sync-lifecycle"></a>

### 1.1 Nightly sync lifecycle (lock → paginate → archive → transform → reconcile)

One invocation of `manage.py sync_ra` delegates to `run_sync`. The runner acquires the non-blocking MySQL advisory lock `onda_sync_ra` before it creates a `SYNC_RUN`. If another process holds the lock, the invocation raises `SyncAlreadyRunning` and creates no run row. Once acquired, the lock is released from `finally` after either completion or crash.

*Evidence: backend/ingestion/runner.py:MySqlAdvisoryLock · backend/ingestion/runner.py:run_sync · backend/ingestion/tests/test_runner.py::RunnerContractTests::test_advisory_lock_refuses_second_run*
...
*Evidence: backend/ingestion/runner.py:_fetch_seed · backend/ingestion/runner.py:_archive_result · backend/ingestion/runner.py:RequestBudget · backend/ingestion/tests/test_runner.py::RunnerContractTests::test_happy_path_two_pages · backend/ingestion/tests/test_client_pacing.py::RaClientPacingTests::test_retry_attempts_consume_shared_request_budget*
...
*Evidence: backend/ingestion/runner.py:_seed_completeness · backend/ingestion/tests/test_completeness_grain.py::WrapperGrainCompletenessTests::test_wrapper_grain_completeness_accepts_duplicate_event_ids · backend/ingestion/tests/test_completeness_grain.py::WrapperGrainCompletenessTests::test_missing_event_id_remains_incomplete_with_numeric_diagnostic*
...
*Evidence: backend/ingestion/runner.py:run_sync · backend/ingestion/reconciler.py:reconcile · backend/ingestion/tests/test_runner.py::RunnerContractTests::test_recovery_sweep_transforms_but_never_reconciles · backend/ingestion/tests/test_reconciler.py::ReconcilerContractTests::test_backfill_and_replay_never_reconcile*
...
*Evidence: backend/ingestion/runner.py:run_sync · backend/ingestion/management/commands/sync_ra.py:Command.handle · backend/ingestion/tests/test_runner.py::RunnerContractTests::test_crash_marks_run · backend/ingestion/tests/test_runner.py::RunnerContractTests::test_telemetry_definition · backend/ingestion/tests/test_sync_command_alarm.py::SyncCommandAlarmTests::test_zero_upsert_run_logs_and_exits_nonzero*
...
*Evidence: backend/ingestion/runner.py:_archive_result · backend/ingestion/models.py:RawIngest · backend/ingestion/tests/test_runner.py::RunnerContractTests::test_transport_failure_seed*
...
*Evidence: backend/ingestion/transformer.py:transform · backend/ingestion/tests/test_transformer.py::TransformerFixtureContractTests::test_whole_payload_failure*
...
*Evidence: backend/ingestion/models.py:RawIngest · backend/ingestion/models.py:RejectedIngest · ERD_REVIEW.md § Accepted implementation deltas*
...
*Evidence: backend/ingestion/transformer.py:transform · backend/ingestion/tests/test_transformer.py::TransformerFixtureContractTests::test_structurally_malformed_event · backend/ingestion/tests/test_transformer.py::TransformerFixtureContractTests::test_missing_event_id*
...
*Evidence: backend/ingestion/transformer.py:_admit_event · backend/ingestion/transformer.py:_record_rejection · backend/ingestion/models.py:RejectedIngest · backend/ingestion/models.py:RejectedIngest.Meta.constraints[uq_rejection_payload_index]*
...
*Evidence: backend/catalog/models.py:CityIdentity · backend/catalog/models.py:VenueIdentity · backend/catalog/models.py:ArtistIdentity · backend/catalog/models.py:EventIdentity · ERD_REVIEW.md § Ingestion → canonical*
...
*Evidence: backend/ingestion/runner.py:run_sync · backend/ingestion/tests/test_runner.py::RunnerContractTests::test_unmapped_seed_refused_before_fetch · backend/catalog/tests/test_models.py::CatalogSchemaTests::test_v1_city_identities_resolve_ra_seed_areas*
...
*Evidence: backend/ingestion/transformer.py:_resolve_venue · backend/ingestion/transformer.py:_resolve_artist · backend/ingestion/transformer.py:_upsert_event · backend/ingestion/tests/test_transformer.py::TransformerCrossCuttingContractTests::test_changed_event_upsert_in_place · backend/ingestion/tests/test_idempotency.py::TransformerIdempotencyTests::test_lineup_reorder*
...
*Evidence: backend/catalog/models.py:Artist · backend/catalog/models.py:ArtistIdentity · onda.dbml anchor “Table ARTIST” · onda.dbml anchor “Table ARTIST_IDENTITY” · backend/ingestion/tests/test_idempotency.py::TransformerIdempotencyTests::test_double_transform_all_fixtures · backend/ingestion/tests/test_idempotency.py::TransformerIdempotencyTests::test_double_transform_after_pagination · backend/ingestion/tests/test_idempotency.py::TransformerIdempotencyTests::test_lineup_reorder_is_idempotent*
...
*Evidence: backend/ingestion/reconciler.py:reconcile · backend/ingestion/tests/test_reconciler.py::ReconcilerContractTests::test_past_events_untouched · backend/ingestion/tests/test_reconciler.py::ReconcilerContractTests::test_scope_is_per_seed_window*
...
*Evidence: backend/ingestion/transformer.py:transform · backend/ingestion/runner.py:run_sync · backend/ingestion/tests/test_reconciler.py::ReconcilerContractTests::test_quarantined_but_listed_resets*
...
*Evidence: backend/ingestion/reconciler.py:_derived_status · backend/ingestion/reconciler.py:reconcile · backend/ingestion/tests/test_reconciler.py::ReconcilerContractTests::test_absence_ladder · backend/ingestion/tests/test_reconciler.py::ReconcilerContractTests::test_presence_resets · backend/ingestion/tests/test_reconciler.py::ReconcilerContractTests::test_resurrection_from_hidden*
...
*Evidence: backend/catalog/views.py:_event_queryset · backend/catalog/views.py:event_detail · backend/users/models.py:DiaryEntry · backend/users/models.py:WillBeThere · backend/users/models.py:FavoriteEvent · backend/users/models.py:FavoriteArtist · backend/users/models.py:FavoriteVenue · ERD_REVIEW.md § App → canonical*
...
*Evidence: backend/catalog/models.py:EventIdentity · backend/catalog/models.py:VenueIdentity · backend/catalog/models.py:ArtistIdentity · backend/catalog/models.py:CityIdentity · ERD_REVIEW.md § Ingestion → canonical*
...
*Evidence: backend/ingestion/runner.py:run_sync · backend/ingestion/transformer.py:_admit_event · backend/catalog/views.py:_serialize_event · backend/ingestion/tests/test_runner.py::RunnerContractTests::test_unmapped_seed_refused_before_fetch · backend/catalog/tests/test_models.py::CatalogSchemaTests::test_v1_city_identities_resolve_ra_seed_areas*
...
*Evidence: backend/ingestion/management/commands/sync_ra.py:Command · backend/ingestion/runner.py:run_sync · backend/config/urls.py:urlpatterns · onda-data-architecture.md § No acquisition in the user request path*

> **Warning:** Never fetch RA on demand from search, an event page, or another user request. That would place an unofficial endpoint in the synchronous path, couple product latency to RA response time and rate limits, and turn provider blocking from a stale catalog into a user-facing failure. Acquisition must remain behind the asynchronous canonical boundary (`onda-data-architecture.md § No acquisition in the user request path`).
...
*Evidence: backend/catalog/views.py:event_detail · backend/users/views.py:home_feed · backend/catalog/tests/test_api.py::CatalogApiTests::test_response_contract_does_not_expose_lifecycle_status*
...
*Evidence: backend/catalog/views.py:VISIBLE_EVENT_STATUSES · backend/catalog/views.py:_event_queryset · backend/catalog/views.py:event_detail · backend/catalog/tests/test_api.py::CatalogApiTests::test_filters_by_city_and_public_lifecycle_visibility · backend/catalog/tests/test_api.py::CatalogApiTests::test_hidden_event_detail_is_not_found · backend/catalog/tests/test_api.py::CatalogApiTests::test_response_contract_does_not_expose_lifecycle_status*
...
*Evidence: backend/catalog/views.py:_date_filter · backend/catalog/tests/test_api.py::CatalogApiTests::test_today_is_upcoming_until_venue_local_midnight · backend/catalog/tests/test_api.py::CatalogApiTests::test_artist_scope_classifies_each_event_in_its_venue_timezone*
...
*Evidence: backend/catalog/views.py:event_list · backend/catalog/tests/test_api.py::CatalogApiTests::test_orders_by_event_date_then_canonical_id · backend/catalog/tests/test_api.py::CatalogApiTests::test_paginates_full_and_partial_pages_without_overlap · backend/catalog/tests/test_api.py::CatalogApiTests::test_past_excludes_today_and_orders_date_then_id_descending · backend/catalog/tests/test_api.py::CatalogApiTests::test_page_beyond_last_page_is_not_found*
...
*Evidence: backend/users/views.py:session_detail · backend/users/views.py:_user_payload · backend/users/tests/test_auth_api.py::AuthApiContractTests::test_session_bootstrap_sets_csrf_cookie_and_reports_guest · backend/users/tests/test_auth_api.py::AuthApiContractTests::test_registration_signs_in_and_returns_self_only_user_shape*
...
*Evidence: frontend/src/api.js:fetchWithCsrf · frontend/src/api.js:fetchJson · backend/users/views.py:register · backend/users/views.py:login_view · backend/users/views.py:logout_view · backend/users/tests/test_auth_api.py::AuthApiContractTests::test_registration_requires_csrf · backend/users/tests/test_auth_api.py::AuthApiContractTests::test_login_persists_session_across_requests · backend/users/tests/test_auth_api.py::AuthApiContractTests::test_logout_invalidates_session_and_is_idempotent*
...
*Evidence: backend/users/models.py:OndaUserManager.profile_content_visible_to · backend/users/models.py:DiaryEntryQuerySet.visible_to · backend/users/models.py:ReviewQuerySet.visible_to · backend/users/models.py:WillBeThereQuerySet.visible_to · backend/users/models.py:DiaryEntryQuerySet.for_aggregation · backend/users/tests/test_profile_api.py::ProfileApiContractTests::test_approved_follower_sees_private_been_and_review_through_sanctioned_boundaries*
...
1. The trace starts when an authenticated user selects `4.5` on an event whose venue-local start boundary has passed. `EventPage.saveRating` converts the selected string to a number and calls `mutate` with `PUT /api/events/{eventId}/been/` and `{"rating": 4.5}`; `mutate` sends the request through `fetchWithCsrf`.
   ...
   *Evidence: frontend/src/pages/EventPage.jsx:EventPage · frontend/src/pages/EventPage.jsx:EventPage.saveRating · frontend/src/pages/EventPage.jsx:EventPage.mutate · frontend/src/api.js:fetchWithCsrf · backend/users/services.py:event_is_loggable · backend/users/tests/test_been_api.py::BeenApiContractTests::test_start_time_gate_rejects_before_and_accepts_at_boundary*
...
2. `users.been_urls.urlpatterns` dispatches the resource to `users.views.event_been`. The view requires authentication, resolves only a publicly visible canonical event through `_visible_event`, and accepts only configured half-star values through `_rating_from_payload`.
   ...
   *Evidence: backend/users/been_urls.py:urlpatterns[event-been] · backend/users/views.py:event_been · backend/users/views.py:_visible_event · backend/users/views.py:_rating_from_payload · backend/users/tests/test_been_api.py::BeenApiContractTests::test_rating_rejects_every_out_of_contract_value*
...
3. `event_been` calls `users.services.save_rating`. The service locks the acting user, looks for the viewer's existing entry, computes the event boundary in `event.venue.city.timezone`, and rejects a first log before the scheduled local wall time. A missing start time opens at local midnight.
   ...
   *Evidence: backend/users/services.py:save_rating · backend/users/services.py:event_is_loggable · backend/users/tests/test_been_api.py::BeenApiContractTests::test_start_time_gate_rejects_before_and_accepts_at_boundary · backend/users/tests/test_been_api.py::BeenApiContractTests::test_null_start_time_opens_at_venue_local_midnight*
...
4. For a first rating, `save_rating` inserts one `DIARY_ENTRY` with `user_id`, `event_id`, `rating=4.5`, a new `rated_at`, and database-generated `created_at`. `uq_diary_user_event` prevents a second row; `ck_diary_rating_half_star` and `ck_diary_rating_rated_at` enforce the stored rating domain and rating/timestamp biconditional. An edit changes `rating` but preserves the existing `rated_at`.
   ...
   *Evidence: backend/users/models.py:DiaryEntry · backend/users/services.py:save_rating · backend/users/tests/test_been_api.py::BeenApiContractTests::test_one_entry_per_user_event_and_edit_preserves_rated_at · backend/users/tests/test_been_api.py::BeenApiContractTests::test_database_rejects_rating_timestamp_mismatches_and_invalid_values*
...
5. `event_been` serializes the entry and returns 201 for creation or 200 for an update. `EventPage.mutate` refetches the event projection after success.
   ...
   *Evidence: backend/users/views.py:event_been · backend/users/services.py:serialize_diary_entry · frontend/src/pages/EventPage.jsx:EventPage.mutate*
...
6. No feed row is written. On a follower's next Home request, `home_feed_rows` builds the `rated_been` branch from visible `DIARY_ENTRY` rows belonging to approved followees, requiring both `rating` and `rated_at`. It emits `activity_at = rated_at` and a fixed-width source key derived from the entry ID. A private actor appears only while the viewer remains an approved follower.
   ...
   *Evidence: backend/users/home_feed.py:home_feed_rows[rated_been] · backend/users/models.py:DiaryEntryQuerySet.visible_to · backend/users/tests/test_home_api.py::HomeFeedContractTests::test_private_actor_activity_disappears_immediately_on_unfollow · backend/users/tests/test_home_api.py::HomeFeedContractTests::test_rating_removal_disappears_and_rerating_repositions*
...
*Evidence: backend/users/home_feed.py:ACTIVITY_TYPES · backend/users/home_feed.py:FEED_FIELDS · backend/users/home_feed.py:home_feed_rows · backend/users/tests/test_home_api.py::HomeFeedContractTests::test_six_type_identical_timestamp_order_and_source_key_tiebreak_are_fixed · ERD_REVIEW.md § 1. User rates an event · PRODUCT_QA_SPEC.md § Amendment to Questions 102, 153, 178, and 189–190*
...
*Evidence: backend/users/home_feed.py:encode_cursor · backend/users/home_feed.py:decode_cursor · backend/users/home_feed.py:_after_cursor · backend/users/home_feed.py:home_feed_rows · backend/users/tests/test_home_api.py::HomeFeedContractTests::test_cursor_is_stable_when_new_activity_arrives · backend/users/tests/test_home_api.py::HomeFeedContractTests::test_six_type_identical_timestamp_order_and_source_key_tiebreak_are_fixed*
...
*Evidence: backend/users/models.py:DiaryEntryQuerySet.visible_to · backend/users/models.py:ReviewQuerySet.visible_to · backend/users/models.py:WillBeThereQuerySet.active_at · backend/users/views.py:profile_favorites · backend/users/views.py:profile_stats · backend/users/home_feed.py:home_feed_rows · backend/users/tests/test_home_api.py::HomeFeedContractTests::test_hidden_items_are_suppressed_and_resurrection_restores_them · backend/users/tests/test_favorites_api.py::FavoritesContractTests::test_hidden_event_suppresses_favorite_and_stats_then_resurrects*
...
*Evidence: backend/users/services.py:remove_rating · backend/users/services.py:remove_will_be_there · backend/users/services.py:unlike_review · backend/users/services.py:unfollow_user · backend/users/services.py:remove_favorite · backend/users/home_feed.py:home_feed_rows · backend/users/tests/test_home_api.py::HomeFeedContractTests::test_rating_removal_disappears_and_rerating_repositions · backend/users/tests/test_will_be_there_api.py::WillBeThereApiContractTests::test_unmark_is_idempotent_and_removes_feed_item*
...
*Evidence: backend/users/models.py:DiaryEntryQuerySet.for_aggregation · backend/users/models.py:WillBeThereQuerySet.active_at · backend/catalog/views.py:event_detail · PRODUCT_QA_SPEC.md § Question 32 · PRODUCT_QA_SPEC.md § Amendment to Questions 93 and 196–198 · backend/users/tests/test_been_api.py::BeenApiContractTests::test_owner_only_diary_and_private_rating_stays_anonymous · backend/users/tests/test_favorites_api.py::FavoritesContractTests::test_event_detail_wbt_count_is_anonymous_inclusive_and_active_only*
...
*Evidence: backend/users/migrations/0004_enforce_diary_user_cascade.py:enforce_user_cascade · backend/users/migrations/0006_enforce_review_database_cascades.py:enforce_cascades · backend/users/migrations/0008_enforce_social_database_cascades.py:enforce_cascades · backend/users/migrations/0010_enforce_wbt_user_cascade.py:enforce_cascade · backend/users/migrations/0013_enforce_favorite_user_cascades.py:forwards · ERD_REVIEW.md § Accepted implementation deltas · backend/users/tests/test_will_be_there_api.py::WillBeThereApiContractTests::test_user_delete_cascades_and_event_delete_is_restricted*
...
*Evidence: backend/users/services.py:delete_review · backend/users/services.py:remove_rating · backend/users/migrations/0006_enforce_review_database_cascades.py:enforce_cascades · backend/users/tests/test_review_api.py::ReviewApiContractTests::test_review_only_delete_spares_rating_and_cascades_likes · backend/users/tests/test_review_api.py::ReviewApiContractTests::test_rating_removal_reports_and_performs_review_cascade*
