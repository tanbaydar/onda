...
- The event rating histogram uses the governed 120×26 compact register. The numeral and histogram form one content-sized cluster aligned at their top edge, with the count directly below; the disclosure keeps the essential target size.
