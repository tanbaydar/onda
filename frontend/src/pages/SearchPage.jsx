...
export default function SearchPage() {
  ...
  return (
    <main className="search-page" onKeyDown={onKeyDown}>
      ...
      {state.error ? <div className="search-error" role="alert"><p>Search could not be loaded.</p><button type="button" onClick={() => setRetry((value) => value + 1)}>Retry</button></div> : null}
