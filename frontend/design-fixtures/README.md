...
These files are real Onda catalog and social API response shapes captured for design work. They are deliberately raw responses: the JSON is only pretty-printed, not cleaned up or reshaped.
