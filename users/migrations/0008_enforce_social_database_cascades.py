...
FOREIGN_KEYS = (
    ("FOLLOW", "follower_id", "DANCED_USER", "fk_follow_follower"),
    ("FOLLOW", "followee_id", "DANCED_USER", "fk_follow_followee"),
    ("NOTIFICATION", "recipient_id", "DANCED_USER", "fk_notification_recipient"),
    ("NOTIFICATION", "actor_id", "DANCED_USER", "fk_notification_actor"),
